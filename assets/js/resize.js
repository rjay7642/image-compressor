// Image Resizer Logic - ImageCompressor (client-side only)
      ...
      <div class="result-card">
        ...
        <div class="result-body">
          ...
          <div class="result-info">
            <p>Original: <strong>${originalWidth} x ${originalHeight}px</strong></p>
            <p>New: <strong>${newWidth} x ${newHeight}px</strong></p>
          </div>
